# agent.py
"""Data_Agent: Aggregates and analyzes historical spending data for a user, 
returning category-level trends and monthly breakdowns 
for downstream insight and nudge generation."""
